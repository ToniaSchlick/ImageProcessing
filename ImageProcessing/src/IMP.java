...
class IMP implements MouseListener{
  ...
  private JMenu getFunctions()
  {
     ...
     JMenuItem forthItem = new JMenuItem("Grayscale");
     forthItem.addActionListener(new ActionListener(){
            @Override
          public void actionPerformed(ActionEvent evt){fun4();}
           });
     
     JMenuItem fifthItem = new JMenuItem("Grayscale and 3x3 mask");
     fifthItem.addActionListener(new ActionListener(){
            @Override
          public void actionPerformed(ActionEvent evt){fun5();}
           });
     
     JMenuItem sixthItem = new JMenuItem("Track Colored Object");
     sixthItem.addActionListener(new ActionListener(){
            @Override
          public void actionPerformed(ActionEvent evt){fun6();}
           });
	 ...
	 int newPic[][] = new int [width][height];
	  for(int i=0; i<width; i++)
	       for(int j=0; j<height; j++){   
	          newPic[i][j] =picture[j][(width-1)-i];
	        } 
	  int temp = height;
	  height = width;
	  width = temp;
